...
export const RegisterPage = () => {
    ...
    const [addUser, {loading}] = useMutation(REGISTER_USER,{
        update(proxy,{data:{register:{id,email,token}}}){
    ...
    return (
               ...
               <ul>
                    {
                        Object.values(errors).map((value) => (
                            <li>
                                <div className={`${closetoggle ? 'hidden' : ''} absolute top-0 right-0 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800`} role="alert">
                                    <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-red-500 bg-red-100 rounded-lg dark:bg-red-800 dark:text-red-200">
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                    </div>
                                    <div class="ml-3 text-sm font-normal">{value}</div>
            ...
            }
        {
            ...
            <div className="absolute sm:top-0 sm:left-0 sm:w-screen sm:h-screen xl:top-197.44px xl:left-483.08px xl:right-483.08px xl:bottom-248.25px xl:w-473.83px xl:border xl:rounded-24px xl:border-b-col-gray xl:h-677.37px box-border">
               <div className="flex flex-col absolute left-10% top-20% w-356.48px">
                    ...
                    <p className="not-italic font-normal text-textnewmed tracking-verytight w-318.88px h-66px mb-34.66px">
                    ...
                    <form className="mb-41.01px" onSubmit={onSubmit}>
                        ...
                        <button type="submit" className="bg-button-color text-white rounded-8px text-sm px-5 py-2.5 text-center w-full">Start coding now</button>   
                    </form>  
                    ...
                    <p className="text-textnewfoot text-footcolor self-center not-italic font-normal sm:mb-80.07px">Adready a member? <Link className="text-blue-600" to="/login">Login</Link></p>
            ...
            <div className="flex justify-between absolute top-120% left-483.08px right-483.08px w-473.83px">     
